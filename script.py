...
def check_higher_priority(current_priority):
    """Check if a higher priority image is found within 0.5 seconds."""
            ...
            if location:
                ...
                for action in actions:
                    ...
                    if action_type == "move_click":
                        ...
                        buffer_time += 0.25  # Increase buffer time by 0.25 seconds
...
def get_image_actions(image_name, image_location):
    ...
    actions_dict = {
        ...
        "ClearSelection.png": [
            ...
            ("move_click", (437, 343), True, 0.05),
            ("move_click", (438, 635), True, 0.05),
            ("move_click", (642, 641), True, 0.05),
            ("move_click", (838, 630), True, 0.05),
            ("move_click", (1429, 637), True, 0.05),
            ("move_click", (1434, 336), True, 0.05),
            ("move_click", (1229, 632), True, 0.05),
            ("move_click", (1233, 343), True, 0.05),
            ("move_click", (1026, 340), True, 0.05),
            ("move_click", (841, 350), True, 0.05),
            ("move_click", (637, 342), True, 0.05),
            ("move_click", (1037, 630), True, 0.05),
            ("move_click", (1705, 868), True, 0.05),
        ],
        "WinRateBaby.png": [
    ...
    return actions_dict.get(image_name, [
        ("move_click", (300, 200), False, 0)  # Default action
    ])
